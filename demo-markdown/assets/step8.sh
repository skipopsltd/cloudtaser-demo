...
echo "  | /proc blocked       |${RED}    NO   ${RESET}|${RED}    NO    ${RESET}|${RED}    NO    ${RESET}|${RED}    NO   ${RESET}|${GREEN}    YES     ${RESET}|"
echo "  | Runtime enforcement |${RED}    NO   ${RESET}|${RED}    NO    ${RESET}|${RED}    NO    ${RESET}|${RED}    NO   ${RESET}|${GREEN}    YES     ${RESET}|"
...
echo "  ${GREEN}*${RESET} Applications work normally — secrets available in process memory"
echo "  ${GREEN}*${RESET} eBPF enforcement blocks /proc/environ at kernel level — even as root"
